...
|-----------------------------------------|--------------|----------|
| 1b: Benchmarks in NLP                   | Written      | 1        |
| 1c: Extra Credit                        | Written      | 1 EC     |
| 1d: Understanding the Dataset           | Written      | 1        |
...
| 4b: Model Evaluation                    | Code         | 2        |
| 4c: Model Training                      | Code         | 4        |
| 4d: Experiment                          | Written      | 2 + 1 EC |
| **Total**                               |              | **20**   |
...
Grading will commence on March 30, and solutions will be released on that day. Therefore, no late
submissions will be accepted after 9:30 AM on March 30. You may resubmit your solutions as many times as you
like; only the final submission will be graded. If the final submission occurs after the deadline on March 23, then
